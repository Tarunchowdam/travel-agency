...
<html lang="en">
    <head>
        ...
        <title> Modify Car | RentalHub</title>
                ...
                <div class="row">
                    <div class="col-md-offset-3 col-md-8">
                        ...
                        <form class="form-horizontal" method="POST" action="ModifyCarProcess" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <select class='form-control' name="carType">
                                        ...
                                        <option <% if(rs.getString("carType").equals("Cars")) out.println("selected"); %>>Cars</option>
                                        <option <% if(rs.getString("carType").equals("Buses")) out.println("selected"); %>>Buses</option>
                                        <option <% if(rs.getString("carType").equals("MiniVans")) out.println("selected"); %>>MiniVans</option>
                                        <option <% if(rs.getString("carType").equals("Bikes")) out.println("selected"); %>>Bikes</option>
                                        <option <% if(rs.getString("carType").equals("Scooties")) out.println("selected"); %>>Scooties</option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label for="inputEmail3" class="col-sm-3 control-label">Vehicle image</label>
                                <div class="col-sm-4">
