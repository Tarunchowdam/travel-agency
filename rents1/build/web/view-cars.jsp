...
<html lang="en">
    <head>
        ...
        <title>View Cars | RentalHub</title>
        ...
        <section id="blog" class="container">
            ...
            <div class="blog">
                ...
                <div class="row car-details">
                    ...
                    <div class="col-md-9">
                        <%
                            out.println("<p><em>" +c.getCarType() + " </em> </p>");
