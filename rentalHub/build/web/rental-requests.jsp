<%@page import="rentalHub.GetRentalRequest"%>
<%@page import="java.util.ArrayList"%>
<%@page import="rentalHub.RentalRequest"%>
<!DOCTYPE html>
<html lang="en">
    <head>
        <meta charset="utf-8">
        ...
        <title> Rental Requests| Rentahub</title>
            ...
            <div class="blog">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <jsp:useBean id="bean" class="rentalHub.RentalRequest"/>
